...
public class Withdrawl extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==b1){
            String wamt=t1.getText();
            Date date=new Date();
            if (wamt.equals("")){
                JOptionPane.showMessageDialog(null,"You have to enter some amount to withdraw..");
            }
            try {
                Connection_Class ob1=new Connection_Class();
                String q1="insert into bank values('"+pin+"','"+date+"','Withdrawl','"+wamt+"')";
                ob1.stm.executeUpdate(q1);
                JOptionPane.showMessageDialog(null,"Rs."+wamt+" Withdrawl Successfully");
                setVisible(false);
